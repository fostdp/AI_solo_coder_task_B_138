...
public class StyleComparisonService {

    private final PavementRepository pavementRepository;
    private final StyleComparisonRepository comparisonRepository;
    ...
    public StyleComparisonResultDTO comparePavements(StyleComparisonRequestDTO request) {
        ...
        String summary = generateSummary(aestheticResults, drainageResults, request.getComparisonType());

        StyleComparison entity = new StyleComparison();
        ...
        StyleComparison saved = comparisonRepository.save(entity);

        StyleComparisonResultDTO dto = new StyleComparisonResultDTO();
    ...
    public List<StyleComparisonResultDTO> getHistory() {
    ...
    private String generateSummary(List<Map<String, Object>> aestheticResults,
