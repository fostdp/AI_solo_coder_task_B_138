...
public class UserDesignService {
    ...
    private final UserPavementDesignRepository repository;
    private final AestheticQuantificationService aestheticService;
    private final DrainageSimulationService drainageService;

    public UserDesignResultDTO processDesign(UserDesignRequestDTO request) {
        UserPavementDesign design = new UserPavementDesign();
        ...
        UserPavementDesign saved = repository.save(design);

        UserDesignResultDTO dto = new UserDesignResultDTO();
    ...
    public List<UserDesignResultDTO> getDesignsBySession(String userSessionId) {
    ...
    public UserDesignResultDTO getDesign(UUID id) {
