...
public class PedestrianSimulatorService {

    private final PedestrianSimulationRepository repository;
    private final PavementRepository pavementRepository;
    private final ObjectMapper objectMapper;

    public PedestrianSimulationResultDTO simulatePedestrianImpact(PedestrianSimulationRequestDTO request) {
        ...
        PedestrianSimulation saved = repository.save(entity);

        PedestrianSimulationResultDTO dto = new PedestrianSimulationResultDTO();
    ...
    public List<PedestrianSimulationResultDTO> getHistory(UUID pavementId) {
        return repository.findByPavementIdOrderByCreatedAtDesc(pavementId)
                .stream().map(this::toDTO).toList();
    }

    private PedestrianSimulationResultDTO toDTO(PedestrianSimulation e) {
        PedestrianSimulationResultDTO dto = new PedestrianSimulationResultDTO();
        dto.setId(e.getId());
